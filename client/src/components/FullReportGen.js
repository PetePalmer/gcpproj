...
function FullReportGen() {
    const [referralData, setReferralData,] = useState("");

    const headers = [
        { label: "ID#", key: "id" },
        { label: "Referrer", key: "referrer_fullname" },
        { label: "Email", key: "referrer_email" },
        { label: "Phone", key: "referrer_phone" },
        { label: "Referrer Agency", key: "referrer_agency" },
        { label: "Agency Zipcode", key: "referrer_agencyzip" },
        { label: "Nearest Location", key: "referrer_nearest_loc" },
